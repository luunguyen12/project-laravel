							...
							<div class="your-order-body" style="padding: 0px 10px">
								<div class="your-order-item">
									...
									@foreach(Cart::content() as $rows)
										<div class="media">
											<img width="25%" src="public/image/
product/{{$rows->options->img}}" alt="" class="pull-left">
											<div class="media-body">
												<p class="font-large">{{$rows->name}}</p>
												
												<span class="color-gray your-order-info">Số luọng: {{$rows->qty}}</span>
											</div>
										</div>
									<!-- end one item -->
									@endforeach
